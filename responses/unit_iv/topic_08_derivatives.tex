...
\midrule
0.0 & 0.000000 & 1.000000 & 0.000000 & A2=0; B2=\texttt{=2-EXP(-2*A2)}; C2=1; D2=\texttt{=ABS(B2-C2)} \\
0.1 & 0.181269 & 1.200000 & 0.018731 & A3=\texttt{=A2+0.1}; B3=\texttt{=2-EXP(-2*A3)}; C3=\texttt{=C2+0.1*(4-2*C2)}; D3=\texttt{=ABS(B3-C3)} \\
0.2 & 0.329680 & 1.360000 & 0.030320 & A4=\texttt{=A3+0.1}; B4=\texttt{=2-EXP(-2*A4)}; C4=\texttt{=C3+0.1*(4-2*C3)}; D4=\texttt{=ABS(B4-C4)} \\
0.3 & 0.451188 & 1.488000 & 0.036812 & (Drag formulas down for all rows) \\
\bottomrule
\end{tabular}
\end{center}
...
\textbf{Answer:} $y(t) = \tfrac{1}{16}(\sin 2t - 2t\cos 2t)$.
