...
Substituting $u = st$ (so $t = u/s$, $dt = du/s$) in the definition of $\mathcal{L}\{t^n\}$:
\[
...
\begin{axis}[
  ...
  xmin=0, xmax=4.5, ymin=-0.5, ymax=1.1,
  grid=major,
  width=12cm, height=6cm
]
  % Approximate J0(t) via the series for small t
  % Series accurate on domain [0, 4.5] (first zero at t ≈ 2.405, minimum near t ≈ 3.83)
  \addplot[blue, very thick, samples=100, domain=0:4.5]
    { 1
      - x^2/4
      + x^4/64
      - x^6/2304
