...
\begin{learnbox}{What Did We Learn?}
When $a$ is \emph{negative} (decay), the shift goes to the \emph{right} in $s$ (replace $s$ by $s+|a|$).
...
\begin{itemize}
  ...
  \item \textbf{Use the summary table:} Keep the 7-row properties table handy during problem
