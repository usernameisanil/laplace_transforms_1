...
\begin{infobox}{Example: $F(s)=\frac{3s+7}{(s+1)(s-2)(s+3)}$}
...
\textbf{Step 4 --- Verify at $s=0$:}
\[
  \text{LHS at } s=0: \frac{3(0)+7}{(0+1)(0-2)(0+3)} = \frac{7}{(1)(-2)(3)} = -\frac{7}{6}.
\]
\[
  \text{RHS at } s=0: \frac{A}{0+1} + \frac{B}{0-2} + \frac{C}{0+3}
  = \frac{-2/3}{1} + \frac{13/15}{-2} + \frac{-1/5}{3}
  = -\frac{2}{3} - \frac{13}{30} - \frac{1}{15} = -\frac{35}{30} = -\frac{7}{6}.\checkmark
\]
...
\begin{infobox}{Example: $F(s)=\frac{s+3}{(s-1)^2(s+2)}$}
Write the decomposition:
\[
...
\begin{infobox}{Example: $F(s)=\frac{2}{s^2(s+1)}$}
Write the decomposition:
\[
...
\begin{infobox}{Example: $F(s)=\frac{s^2+2s+3}{(s^2+2s+5)(s-1)}$}
Write the decomposition:
\[
...
\[
  ...
  = \frac{1}{2q^2}\bigl(\sin(qt)-qt\cos(qt)\bigr)\,e^{-pt}.
\]
Equivalently:
\[
  \mathcal{L}^{-1}\!\left\{\frac{1}{[(s+p)^2+q^2]^2}\right\}
  = \frac{1}{2q^3}\bigl(\sin(qt)-qt\cos(qt)\bigr)\,e^{-pt}.
\]
...
$A_1=B_1=A_2=0$, $B_2=1$). Using the formula with $q=2$, the factor is $\frac{1}{2q^3} = \frac{1}{2(2^3)} = \frac{1}{16}$:
\[
  \mathcal{L}^{-1}\!\left\{\frac{1}{(s^2+4)^2}\right\}
  = \frac{1}{16}\bigl(\sin(2t)-2t\cos(2t)\bigr), \quad t\geq 0.
\]
...
\begin{infobox}{Find $\mathcal{L}^{-1}\!\left\{\frac{2s^2+5s+3}{(s+1)(s+2)(s+3)}\right\}$}
...
\begin{infobox}{Find $\mathcal{L}^{-1}\!\left\{\frac{1}{s^2(s^2+4)}\right\}$}
...
\begin{infobox}{Find $\mathcal{L}^{-1}\!\left\{\frac{2s^2-s+3}{(s-1)(s^2+4)}\right\}$}
...
\item \textbf{How does the First Shift (Frequency Shift) theorem interact
...
\item \textbf{Solve completely: Find
  ...
  Verify at $s=0$:
  \[
    \text{LHS} = \frac{7}{(1)(-2)(3)} = -\frac{7}{6}; \qquad
    \text{RHS} = \frac{-1}{1} + \frac{13/5}{-2} + \frac{17/5}{3}
    = -1 - \frac{13}{10} + \frac{17}{15} = -\frac{30}{30} - \frac{39}{30} + \frac{34}{30} = -\frac{35}{30} = -\frac{7}{6}.\checkmark
  \]
  \[
...
\item $\mathcal{L}^{-1}\!\left\{\dfrac{1}{s(s^2+1)}\right\}$
  ...
  Compare $s^1$: $C=0$, $s^2$: $A+B=0\implies B=-1$.
  Answer: $1-\cos t$.
...
\item $\mathcal{L}^{-1}\!\left\{\dfrac{s^3+1}{s^2(s^2+4)}\right\}$
  ...
  \textit{Hint:} Check: $\deg P = 3 < \deg Q = 4$,
  so the fraction is proper. Decompose as $A/s+B/s^2+(Cs+D)/(s^2+4)$.
  Comparing $s^0$: $1=4B\implies B=1/4$. $s^1$: $0=4A\implies A=0$.
  $s^2$: $0=B+D\implies D=-1/4$. $s^3$: $1=A+C\implies C=1$.
  Answer: $\tfrac{1}{4}t+\cos(2t)-\tfrac{1}{8}\sin(2t)$.
